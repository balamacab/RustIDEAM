...
| [DEF-0012](DEF-0012-user-provided-source-quote-fidelity.md) | P1 | Generated user-provided source quotes can drift from literal client text | [#91](https://github.com/balamacab/RustIDEAM/issues/91) | implementing |
