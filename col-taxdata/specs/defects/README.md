...
| [DEF-0011](DEF-0011-rejected-llm-output-evidence.md) | P1 | Rejected CASE LLM outputs lose auditable failure evidence | [#90](https://github.com/balamacab/RustIDEAM/issues/90) | implementing |
